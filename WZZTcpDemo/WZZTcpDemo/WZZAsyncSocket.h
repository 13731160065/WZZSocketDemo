...
//  本类为AsyncSocket，因避免socket框架重复，我添加了WZZ前缀

#import <Foundation/Foundation.h>

@class WZZAsyncSocket;
@class WZZAsyncReadPacket;
@class WZZAsyncWritePacket;

extern NSString *const WZZAsyncSocketException;
extern NSString *const WZZAsyncSocketErrorDomain;

enum WZZAsyncSocketError
{
...
typedef enum WZZAsyncSocketError WZZAsyncSocketError;

@protocol WZZAsyncSocketDelegate
@optional
...
**/
- (void)onSocket:(WZZAsyncSocket *)sock willDisconnectWithError:(NSError *)err;
...
**/
- (void)onSocketDidDisconnect:(WZZAsyncSocket *)sock;
...
**/
- (NSRunLoop *)onSocket:(WZZAsyncSocket *)sock wantsRunLoopForNewSocket:(WZZAsyncSocket *)newSocket;
...
**/
- (void)onSocket:(WZZAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)onSocket:(WZZAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)onSocket:(WZZAsyncSocket *)sock
...
**/
- (void)onSocketDidSecure:(WZZAsyncSocket *)sock;
...
@interface WZZAsyncSocket : NSObject
{
	...
	WZZAsyncReadPacket *theCurrentRead;
	NSTimer *theReadTimer;
	NSMutableData *partialReadBuffer;
	
	NSMutableArray *theWriteQueue;
	WZZAsyncWritePacket *theCurrentWrite;
